...
1º Consumer do Módulo 4 do Projeto de PMP para entrega do Projeto Final, nele foi atendido alguns dos seguintes requisitos:
...
|------------|------------------|---------------------------------------------------------|
| Módulo 4   | Producer Kafka   | [Módulo 4.1](https://github.com/PMP-Projects/modulo4)                                        |
| Módulo 4.1 | Consumer 1 Kafka | Este Repositório |
...
│   ├── 📁 main
│   │   ├── 📁 java
│   │   │   └── 📁 modulo4_consumer1 ← Módulo principal do Consumer
...
│   │   │       └── 📄 Modulo4Consumer1Application.java ← Classe principal da aplicação
...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=PMP-Projects_modulo4.1&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=PMP-Projects_modulo4.1)
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=PMP-Projects_modulo4.1&metric=bugs)](https://sonarcloud.io/summary/new_code?id=PMP-Projects_modulo4.1)
[![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=PMP-Projects_modulo4.1&metric=code_smells)](https://sonarcloud.io/summary/new_code?id=PMP-Projects_modulo4.1)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=PMP-Projects_modulo4.1&metric=coverage)](https://sonarcloud.io/summary/new_code?id=PMP-Projects_modulo4.1)
[![Duplicated Lines (%)](https://sonarcloud.io/api/project_badges/measure?project=PMP-Projects_modulo4.1&metric=duplicated_lines_density)](https://sonarcloud.io/summary/new_code?id=PMP-Projects_modulo4.1)
[![Lines of Code](https://sonarcloud.io/api/project_badges/measure?project=PMP-Projects_modulo4.1&metric=ncloc)](https://sonarcloud.io/summary/new_code?id=PMP-Projects_modulo4.1)
[![Reliability Rating](https://sonarcloud.io/api/project_badges/measure?project=PMP-Projects_modulo4.1&metric=reliability_rating)](https://sonarcloud.io/summary/new_code?id=PMP-Projects_modulo4.1)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=PMP-Projects_modulo4.1&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=PMP-Projects_modulo4.1)
[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=PMP-Projects_modulo4.1&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=PMP-Projects_modulo4.1)
[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=PMP-Projects_modulo4.1&metric=vulnerabilities)](https://sonarcloud.io/summary/new_code?id=PMP-Projects_modulo4.1)
...
```bash
# Clonar repositório
git clone https://github.com/PMP-Projects/modulo4.1.git
